...
m = input('Enter mean value:');
n1 = input('Enter standard deviation:');
t0 = input('Enter data length:'); % Generate normally distributed random numbers
...
V = input('Enter ship speed:'); % Ship speed
DT = input('Enter displacement:'); % Ship displacement, in tons
...
title('Ship Radiated Noise Time Domain Waveform');
xlabel('Time');
