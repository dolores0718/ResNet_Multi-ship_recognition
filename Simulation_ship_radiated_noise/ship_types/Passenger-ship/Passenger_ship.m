...
V = 22; % Ship speed
DT = 20000; % Ship displacement, in tons
...
title('Passenger-ship Radiated Noise');
xlim([0,5000]);
...
title('Passenger-ship Radiated Noise Time Domain Waveform');
xlabel('Time(s)');
...
zlabel('Amplitude');
title('3D MFCC Features of Passenger-ship');
colorbar;
colormap("parula");
