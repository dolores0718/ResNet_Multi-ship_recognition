...
V = 25; % Ship speed
DT = 15000; % Ship displacement, in tons
...
title('Cargo Radiated Noise Time Domain Waveform');
xlabel('Time(s)');
...
zlabel('Amplitude');
title('3D MFCC Features of Cargo');
colorbar;
colormap("parula");
...
Fs=320000
figure; 
spectrogram(ss, 512, 500, 1024, Fs, 'yaxis');
title('STFT of Cargo');
xlabel('Time (s)');
ylabel('Frequency (Hz)');  % 左边的y轴标签
